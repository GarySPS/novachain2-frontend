...
const trendingAssets = [
  { id: 1, name: "BTC/USDT", change: "+2.3%" },
  { id: 2, name: "ETH/USDT", change: "+1.9%" },
  // ... more
];
const recentTransactions = [
  { id: 1, asset: "BTC", amount: "0.5", time: "1m ago" },
  { id: 2, asset: "ETH", amount: "2.3", time: "3m ago" },
  // ... more
];
        ...
        <div className="flex items-center md:hidden">
          ...
          <div className="flex space-x-1">
            <div className="flex justify-center items-center w-8 h-7 rounded-lg bg-theme-surface-pure border border-theme-stroke text-0">
              <Icon className="!w-4 !h-4 fill-theme-primary" name="arrow-bottom" />
            </div>
            <div className="flex justify-center items-center w-8 h-7 rounded-lg bg-theme-surface-pure border border-theme-stroke text-0">
              <Icon className="!w-4 !h-4 fill-theme-primary" name="arrow-top" />
            </div>
          </div>
        </div>
        <div className="flex items-center md:hidden">
